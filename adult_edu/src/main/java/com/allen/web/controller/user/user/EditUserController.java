...
public class EditUserController extends BaseController {
    ...
    public String open(HttpServletRequest request,
        ...
        request.setAttribute("userGroupId", findUserGroupUserByUserIdService.find(id).getUserGroupId());
    ...
    @ResponseBody
    public JSONObject editor(HttpServletRequest request, User user, long userGroupId) throws Exception {
