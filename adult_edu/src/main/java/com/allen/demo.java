 ...
 */
public class demo {
    private static String appId="1003";
    private static String appKey="721ce638f22ff989f4dc2166609a0812";
    private static String token="";
    private static long expireTime=0;
    private static String url="http://xiwang.attop.com:8082";
    private static int againGetTokenNum = 0;

    public static void main(String[] args){
        String code = "021011113002";
        String msg=getData(code);
    ...
    public static String getData(String code){
        ...
        try{
            initToken();
            String u=url+"/xiwang/getStudentOwn.json?appId="+appId+"&code="+code+"&token="+token;
            result = sendGet(u);
            JSONObject json = JSONObject.parseObject(result);
            if(json.get("state").toString().equals("204") && againGetTokenNum < 3){
                againGetTokenNum++;
                getData(code);
            }else{
                againGetTokenNum = 0;
